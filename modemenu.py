...
def main():
    ...
    buttons = [
        Button("TRAINING MODE", '#89CFF0', 340, 80, (WIDTH / 2 - 340 / 2, HEIGHT / 2 - 200), 6,
               "Unlimited time to read and answer by dragging options to a submission box. Questions cannot be skipped until right answer is chosen.", training_mode),
        Button("LIGHTNING MODE", '#89CFF0', 365, 80, (WIDTH / 2 - 360 / 2, HEIGHT / 2 - 80), 6,
               "Fast-paced, with a time limit. Similar drag-and-drop gameplay but with points for correct answers and a leaderboard.", lightning_mode),
