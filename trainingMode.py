"""
This module contains the main functionality for the 'Training Mode' of the game.
It initializes the game window, loads resources, and handles user interaction.

Functions:
    main(): Initializes the game, creates the main loop, handles events, and updates the game state.

Classes:
    Button: Represents a clickable button in the game UI.
    DraggableItem: Represents an item that can be dragged and dropped within the game UI.
...
def main():
    """
    The main function of the module. Initializes Pygame, sets up the display, 
    loads resources, and enters the main game loop.
    """
    pygame.init()
